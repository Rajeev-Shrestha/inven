...
{
    public class ProductViewModel : IWebItem
    {
        ...
        public virtual List<string> SmallImageUrls { get; set; }
        public virtual List<string> MediumImageUrls { get; set; }
        public virtual List<string> LargeImageUrls { get; set; }
