...
{
    internal class DiscountTypeMapping
    {
        public DiscountTypeMapping(EntityTypeBuilder<DiscountTypes> entityBuilder)
        {
            ...
            entityBuilder.HasOne(t => t.LastUser)
                .WithMany(t => t.DiscountTypesModified)
                .HasForeignKey(d => d.LastUpdatedBy)
                .OnDelete(DeleteBehavior.Restrict);

            entityBuilder.HasOne(t => t.CreatedByUser)
                .WithMany(t => t.DiscountTypesCreated)
