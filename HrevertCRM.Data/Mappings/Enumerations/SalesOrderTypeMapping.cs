...
{
    internal class SalesOrderTypeMapping
    {
        public SalesOrderTypeMapping(EntityTypeBuilder<SalesOrderTypes> entityBuilder)
        {
            ...
            entityBuilder.HasOne(t => t.LastUser)
                .WithMany(t => t.SalesOrderTypesModified)
                .HasForeignKey(d => d.LastUpdatedBy)
                .OnDelete(DeleteBehavior.Restrict);

            entityBuilder.HasOne(t => t.CreatedByUser)
                .WithMany(t => t.SalesOrderTypesCreated)
