...
{
    internal class AccountCashFlowTypeMapping
    {
        public AccountCashFlowTypeMapping(EntityTypeBuilder<AccountCashFlowTypes> entityBuilder)
        {
            ...
            entityBuilder.HasOne(t => t.LastUser)
                .WithMany(t => t.AccountCashFlowTypeModified)
                .HasForeignKey(d => d.LastUpdatedBy)
                .OnDelete(DeleteBehavior.Restrict);

            entityBuilder.HasOne(t => t.CreatedByUser)
                .WithMany(t => t.AccountCashFlowTypeCreated)
