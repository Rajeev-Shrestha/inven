...
{
    internal class JournalTypeMapping
    {
        public JournalTypeMapping(EntityTypeBuilder<JournalTypes> entityBuilder)
        {
            ...
            entityBuilder.HasOne(t => t.LastUser)
                .WithMany(t => t.JournalTypesModified)
                .HasForeignKey(d => d.LastUpdatedBy)
                .OnDelete(DeleteBehavior.Restrict);

            entityBuilder.HasOne(t => t.CreatedByUser)
                .WithMany(t => t.JournalTypesCreated)
