...
{
    internal class AccountTypeMapping
    {
        public AccountTypeMapping(EntityTypeBuilder<AccountTypes> entityBuilder)
        {
            ...
            entityBuilder.HasOne(t => t.LastUser)
                .WithMany(t => t.AccountTypesModified)
                .HasForeignKey(d => d.LastUpdatedBy)
                .OnDelete(DeleteBehavior.Restrict);

            entityBuilder.HasOne(t => t.CreatedByUser)
                .WithMany(t => t.AccountTypesCreated)
