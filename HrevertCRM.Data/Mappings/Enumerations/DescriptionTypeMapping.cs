...
{
    internal class DescriptionTypeMapping
    {
        public DescriptionTypeMapping(EntityTypeBuilder<DescriptionTypes> entityBuilder)
        {
            ...
            entityBuilder.HasOne(t => t.LastUser)
                .WithMany(t => t.DescriptionTypesModified)
                .HasForeignKey(d => d.LastUpdatedBy)
                .OnDelete(DeleteBehavior.Restrict);

            entityBuilder.HasOne(t => t.CreatedByUser)
                .WithMany(t => t.DescriptionTypesCreated)
