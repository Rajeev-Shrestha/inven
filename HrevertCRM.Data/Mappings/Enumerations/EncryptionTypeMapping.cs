...
{
    internal class EncryptionTypeMapping
    {
        public EncryptionTypeMapping(EntityTypeBuilder<EncryptionTypes> entityBuilder)
        {
            ...
            entityBuilder.HasOne(t => t.LastUser)
                .WithMany(t => t.EncryptionTypesModified)
                .HasForeignKey(d => d.LastUpdatedBy)
                .OnDelete(DeleteBehavior.Restrict);

            entityBuilder.HasOne(t => t.CreatedByUser)
                .WithMany(t => t.EncryptionTypesCreated)
