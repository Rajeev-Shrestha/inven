...
namespace HrevertCRM.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> ConfirmEmail(string userId, string code)
        {
            ...
            return View(result.Succeeded ? "Email Confirmed Successfully!" :
        ...
        public async Task<IActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            ...
            using (var client = new SmtpClient())
            {
                ...
                {
                    TextBody = $"Please reset your password by clicking here: " +
        ...
        public async Task<IActionResult> ResetPassword(ResetPasswordViewModel model)
        {
            ...
            var userData= _userQueryProcessor.GetUserByUserId(model.UserId);
