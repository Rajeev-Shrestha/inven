(function () {
    'use strict';
    angular.module("app-themeSetting", ['ui.router', 'colorpicker.module', 'base64', 'ngCropper'])
    ...
    function configRoutes($urlRouterProvider, $stateProvider, $httpProvider) {
        $urlRouterProvider.otherwise('/themeSetting');

        $stateProvider
        .state('themeSetting',
        {
            url: '/themeSetting',
            templateUrl: '/templates/themeSetting/themeSetting.html',
