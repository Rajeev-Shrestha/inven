(function () {
    ...
    purchaseController.$inject = ['$http', '$filter', '$scope', 'purchaseService'];
    function purchaseController($http, $filter, $scope, purchaseService) {
        ...
        function getPaymentTerm() {
            purchaseService.getPaymentTerm().then(function (result) {
                if (result.success) {
        ...
        function getPaymentTermItems(term) {
            ...
            vm.termAssign = true;
            getAllPaymentMethods();
            purchaseService.getPaymentByTermId(term.id)
        ...
        function savePaymentRole(items) {
            ...
            purchaseService.savePaymentRoles(vm.newItems)
                .then(function (result) {
                    if (result.success) {
                        vm.dirtyList = false;
        ...
        function loadAllPaymentTermTypes() {
            purchaseService.GetAllPaymentTermTypes()
                    .then(function (result) {
                        if (result.success) {
        ...
        function loadAllPaymentDiscountTypes() {
            ...
            purchaseService.GetAllPaymentDiscountTypes()
                    .then(function (result) {
                        if (result.success) {
        ...
        function loadAllDueTypes() {
            purchaseService.GetAllDueTypes()
                    .then(function (result) {
                        if (result.success) {
        ...
        function loadAllDueDateTypes() {
            purchaseService.GetAllDueDateTypes()
                    .then(function (result) {
                        if (result.success) {
        ...
        function editPaymentTerm(termId, checked) {
            if (checked) {
                purchaseService.getPaymentTermById(termId).then(function (result) {
                    if (result.success) {
                        vm.onAccountSelected = null;
                        vm.onSpecifiedDaysSelected = null;
        ...
        function searchTextChangedForPaymentTerm(text, checked) {
            purchaseService.searchTextForPaymentTerm(text, checked)
              .then(function (result) {
                  if (result.success) {
                      vm.allPaymentTerm = result.data;
                  }
        ...
        function getInactivePaymentTerm() {
            purchaseService.getInactivePaymentTerm()
                    .then(function (result) {
                        if (result.success) {
                            vm.allPaymentTerm = result.data;
                        } else {
        ...
        function getPaymentTermWithoutAccountType() {
            purchaseService.getPaymentTermWithoutAccountType()
                    .then(function (result) {
                        if (result.success) {
        ...
        function deletePaymentTerm(item) {
            purchaseService.deletePaymentTerm(item.id).then(function (result) {
                if (result.success) {
        ...
        function savePaymentTerm(item) {
            ...
            if (item.id === undefined) {
                purchaseService.createPaymentTerm(item)
                    .then(function (result) {
                        if (result.success) {
                            vm.activePaymentTerm = null;
                            getPaymentTerm();
                ...
                purchaseService.updatePaymentTerm(item)
                    .then(function (result) {
                        if (result.success) {
                            vm.activePaymentTerm = null;
                            getPaymentTerm();
