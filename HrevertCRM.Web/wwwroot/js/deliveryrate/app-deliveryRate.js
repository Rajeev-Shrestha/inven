(function () {
    "use strict";
    angular.module("app-deliveryRate", ['ui.router', 'ngStorage', 'ngAria', 'ngMessages'])
    ...
    function configRoutes($urlRouterProvider, $stateProvider, $httpProvider) {
        $urlRouterProvider.otherwise('/deliveryRate');

        $stateProvider
            .state('deliveryRate',
            {
                url: '/deliveryRate',
                templateUrl: '/templates/deliveryRate/deliveryRate.html',
